...
//  volatile uint32_t *bb_dc_port;
    ...
    volatile uint32_t dma_tc_flag_mask;
    volatile uint32_t *dma_state_reg;
    volatile uint32_t dma_tc_clear_mask;
    volatile uint32_t *dma_state_clear_reg;
    volatile uint32_t *bb_dma_tcie;
    
    DMA_HandleTypeDef hdma;
    volatile uint32_t *bb_spi_txdmaen;
    volatile uint32_t *bb_dma_sxcr_en;
    volatile uint16_t dmaBuff;
